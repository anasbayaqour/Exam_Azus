    ...
    <div class="modal-overlay" id="editModal">
        <div class="modal">
            <div class="modal-header">
                <h3 class="modal-title">Change Exam Status</h3>
            ...
            <div class="modal-footer">
                ...
                <button class="btn primary-btn" id="saveStatusBtn">Save Changes</button>
            </div>
        </div>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    .catch(error => {
                        Swal.fire({
                            title: 'Error!',
                            text: 'An error occurred while updating the exam status',
                            icon: 'error',
                            confirmButtonColor: '#ef4444'
                        });
                    });
